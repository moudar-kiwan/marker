<?php if (self::$_tpl_vars['customers']): ?>
<?php if (isset(self::$_sections['i'])) unset(self::$_sections['i']);
self::$_sections['i']['name'] = 'i';
self::$_sections['i']['loop'] = is_array($_loop=self::$_tpl_vars['customers']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
<div class="result_item" onclick="product.search_customer_select(<?php echo self::$_tpl_vars['customers'][self::$_sections['i']['index']]['id']; ?>
, '<?php echo self::$_tpl_vars['customers'][self::$_sections['i']['index']]['title']; ?>
');"><?php echo self::$_tpl_vars['customers'][self::$_sections['i']['index']]['title']; ?>
</div>
<?php endfor; endif; ?>
<?php else: ?>
