<div class="modal_head">
	<span><?php echo self::$_tpl_vars['modal_title']; ?>
</span>
	...
	<div style="display: table; width: 100%; padding-top: 15px;">
		<div style="display: table-cell; width: 50%; padding-right: 5px;">
			...
			<div class="selector" style="position: relative;" onclick="common.results_toggle(this, event);">
				<input type="text" class="input_primary" placeholder="Название этикетки" value="<?php echo self::$_tpl_vars['product']['label_title']; ?>
" autocomplete="off" autocorrect="off" autocapitalize="off" disabled style="cursor: pointer;">
				<input type="hidden" id="label_id" value="<?php echo self::$_tpl_vars['product']['label_id']; ?>
">
...
?>
					<div class="result_item" onclick="common.result_select(this, '<?php echo self::$_tpl_vars['labels'][self::$_sections['i']['index']]['title']; ?>
', <?php echo self::$_tpl_vars['labels'][self::$_sections['i']['index']]['id']; ?>
, 'full'); product.options_from_label(<?php echo self::$_tpl_vars['labels'][self::$_sections['i']['index']]['id']; ?>
);"><?php echo self::$_tpl_vars['labels'][self::$_sections['i']['index']]['title']; ?>
</div>
					<?php endfor; endif; ?>
				</div>
			</div>
		...
		<div style="display: table-cell; width: 50%; padding-left: 5px;">
			...
			<input class="input_primary" id="quantity" type="text" value="<?php echo self::$_tpl_vars['product']['quantity']; ?>
" oninput="input_error_hide(this);" maxlength="10" autocomplete="off" autocorrect="off" autocapitalize="off">
		</div>
	</div>
...
self::include_file(['file'=>"./partials/modal/products/product_edit_option.html", 'vars'=>['option' => self::$_tpl_vars['product']['options'][self::$_sections['i']['index']],'count' => self::$_tpl_vars['count_options']]]);
...
self::include_file(['file'=>"./partials/modal/products/product_edit_files.html", 'vars'=>['files' => self::$_tpl_vars['product']['files']]]);
self::$_tpl_vars = $_html_tpl_vars;
unset($_html_tpl_vars);
 ?></div>
	</div>
