...
" autocomplete="off" autocorrect="off" autocapitalize="off"></div>
	<div class="product_edit_option_units selector" onclick="common.results_toggle(this, event);">
		<input type="text" class="input_primary" placeholder="Ед. измерения" value="<?php echo self::$_tpl_vars['option']['units_title']; ?>
" autocomplete="off" autocorrect="off" autocapitalize="off" style="cursor: pointer;">
...
', <?php echo self::$_tpl_vars['units'][self::$_sections['j']['index']]['id']; ?>
, 'icon');"><?php echo self::$_tpl_vars['units'][self::$_sections['j']['index']]['title_short']; ?>
