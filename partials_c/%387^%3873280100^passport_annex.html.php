...
"><?php echo self::$_tpl_vars['passport']['title']; ?>
		...
		<i class="icon icon_next"></i>
		<span><?php echo self::$_tpl_vars['annex']['title']; ?>
</span>
	</div>
	
	<div style="font-size: 18px; color: #04368f; margin-top: 10px;"><?php echo self::$_tpl_vars['annex']['title']; ?>
</div>
	<div style="margin-top: 15px;">
		<div onclick="passport.files_upload(<?php echo self::$_tpl_vars['passport']['id']; ?>
, <?php echo self::$_tpl_vars['annex']['id']; ?>
, 2, 0, 0, 0, 'common');" class="btn_primary" style="height: 30px; line-height: 30px; width: auto; text-align: center; margin-right: 8px;">Загрузить</div>
		<div onclick="passport.annex_edit_window(<?php echo self::$_tpl_vars['passport']['id']; ?>
, <?php echo self::$_tpl_vars['annex']['id']; ?>
